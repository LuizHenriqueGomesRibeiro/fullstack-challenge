import { baselineStartX, floorY, GRAPH_HEIGHT, GRAPH_WIDTH, PLOT, plotWidth, useCrashGraph } from "../home-hero-board/crash-graph-context";
import { animated } from '@react-spring/web';

export default function CrashGraphSvg({
  multiplierLabel,
  crashPointLabel,
  crashDurationLabel,
}: {
